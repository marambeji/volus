                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => setHistoryTarget({ entityType: 'Employee', entityId: String(activeEmp.id), name: activeEmp.name })} className="p-1 text-slate-400 hover:text-indigo-600 bg-slate-100 hover:bg-indigo-50 dark:bg-slate-700 dark:hover:bg-slate-600 rounded-md transition-colors" title="View Employee Audit History">
                          <History size={14} />
                        </button>
                      </div>
